...
const OPERATIONS = Object.freeze([
  ...
  { id: 'fuse', label: 'A2A-Fusion', labelEn: 'A2A fusion' },
  { id: 'fuse_v2', label: 'A2A/Standard-Fusion V2', labelEn: 'A2A/standard fusion V2' },
...
const BUILTIN_SOURCES = Object.freeze([
  ...
  source('a2a.shake.airframe', 'A2A Flugmodell', 'Airframe Shake', 'L:AirframeShake', 'number', 'number'),
  source('a2a.shake.panel.vertical', 'A2A Flugmodell', 'Panel Vertical Shake', 'L:PanelVerticalShake', 'number', 'number'),
  source('a2a.shake.panel.horizontal', 'A2A Flugmodell', 'Panel Horizontal Shake', 'L:PanelHorizontalShake', 'number', 'number'),
  source('a2a.camera.height', 'A2A Flugmodell', 'Camera Height (experimental)', 'L:CameraHeight', 'number', 'number'),
  ...
  source('std.on_ground', 'MSFS Flugzustand', 'Sim On Ground', 'SIM ON GROUND', 'Bool', 'boolean'),
...
const OUTPUT_LOCALIZATION = Object.freeze({
  ...
  'ang_vel.0': { de: 'Drehrate Pitch', en: 'Pitch angular velocity', helpDe: 'Nickrate um die DCS-Pitchachse in rad/s. Die A2A-Fusion integriert die AccuSim-Drehbeschleunigung und korrigiert nur deren langsame Drift über die Flugzeuglage.', helpEn: 'Pitch rate around the DCS pitch axis in rad/s. A2A fusion integrates AccuSim angular acceleration and uses aircraft attitude only to correct slow drift.' },
...
const OUTPUTS = Object.freeze([
  ...
  output('acc.2', 'Motion', 'Acceleration vertical', 'acc', 'g', {
    ...
    basic: true,
    simpleSources: [
      { sourceId: 'std.gforce', operation: 'direct' },
  ...
  output('ang_vel.0', 'Motion', 'Angular Velocity pitch', 'ang_vel', 'radps', {
    ...
    simpleSources: [
      ...
      { sourceId: 'a2a.rotacc.x', operation: 'fuse' }
    ]
  }),
  output('ang_vel.1', 'Motion', 'Angular Velocity roll', 'ang_vel', 'radps', {
    ...
    simpleSources: [
      ...
      { sourceId: 'a2a.rotacc.z', operation: 'fuse' }
    ]
  }),
  output('ang_vel.2', 'Motion', 'Angular Velocity yaw', 'ang_vel', 'radps', {
    ...
    simpleSources: [
      ...
      { sourceId: 'a2a.rotacc.y', operation: 'fuse' }
    ]
  }),
...
const DIAGNOSTIC_SOURCE_IDS = Object.freeze([
  ...
  'a2a.rotacc.z',
  'a2a.shake.airframe',
  'a2a.shake.panel.vertical',
  'a2a.shake.panel.horizontal',
  'a2a.camera.height',
  'std.acc.body.x',
  'std.acc.body.y',
  'std.acc.body.z',
...
const MOTION_MIX_PROFILES = Object.freeze({
  legacy: Object.freeze({
    id: 'legacy',
    channels: Object.freeze({
      'acc.0': Object.freeze({ enabled: true, sourceId: 'a2a.acc.x', inputUnit: 'mps2', operation: 'direct', invert: false, scale: 1, offset: 0 }),
      'acc.1': Object.freeze({ enabled: true, sourceId: 'a2a.acc.z', inputUnit: 'mps2', operation: 'direct', invert: false, scale: 1, offset: 0 }),
      'acc.2': Object.freeze({ enabled: true, sourceId: 'a2a.acc.y', inputUnit: 'mps2', operation: 'direct', invert: false, scale: 1, offset: 0 }),
      'ang_vel.0': Object.freeze({ enabled: true, sourceId: 'a2a.rotacc.x', inputUnit: 'radps2', operation: 'fuse', invert: false, scale: 1, offset: 0 }),
      'ang_vel.1': Object.freeze({ enabled: true, sourceId: 'a2a.rotacc.z', inputUnit: 'radps2', operation: 'fuse', invert: false, scale: 1, offset: 0 }),
      'ang_vel.2': Object.freeze({ enabled: true, sourceId: 'a2a.rotacc.y', inputUnit: 'radps2', operation: 'fuse', invert: false, scale: 1, offset: 0 })
    })
  }),
  v2: Object.freeze({
    id: 'v2',
    channels: Object.freeze({
      'acc.0': Object.freeze({ enabled: true, sourceId: 'a2a.acc.x', inputUnit: 'mps2', operation: 'direct', invert: false, scale: 1, offset: 0 }),
      'acc.1': Object.freeze({ enabled: true, sourceId: 'a2a.acc.z', inputUnit: 'mps2', operation: 'direct', invert: false, scale: 1, offset: 0 }),
      'acc.2': Object.freeze({ enabled: true, sourceId: 'std.gforce', inputUnit: 'g', operation: 'direct', invert: false, scale: 1, offset: 0 }),
      'ang_vel.0': Object.freeze({ enabled: true, sourceId: 'a2a.rotacc.x', inputUnit: 'radps2', operation: 'fuse_v2', invert: false, scale: 1, offset: 0 }),
      'ang_vel.1': Object.freeze({ enabled: true, sourceId: 'std.angular.body.z', inputUnit: 'radps', operation: 'direct', invert: false, scale: 1, offset: 0 }),
      'ang_vel.2': Object.freeze({ enabled: true, sourceId: 'std.angular.body.y', inputUnit: 'radps', operation: 'direct', invert: false, scale: 1, offset: 0 })
    })
  })
});
...
const TURBULENCE_PRESETS = Object.freeze([
  ...
  Object.freeze({
    id: 'high',
    label: 'Hoch',
    description: 'Das bisherige, im Flugtest bewährte Extrem-Preset.',
    labelEn: 'High',
    descriptionEn: 'The former Extreme preset validated in flight testing.',
    mix: 1,
    gain: 5,
    lowCutHz: 0.3,
    highCutHz: 10,
  ...
  Object.freeze({
    id: 'extreme',
    label: 'Extrem',
    description: 'Noch stärkere Teststufe; Plattform- und DRSM-Limits sorgfältig überwachen.',
    labelEn: 'Extreme',
    descriptionEn: 'Stronger test level; carefully monitor platform and DRSM limits.',
    mix: 1,
    gain: 7,
    lowCutHz: 0.2,
    highCutHz: 14,
...
const DEFAULT_CHANNELS = Object.freeze({
  ...
  'acc.2': { enabled: true, sourceId: 'std.gforce', inputUnit: 'g', operation: 'direct', invert: false, scale: 1, offset: 0 },
  'ang_vel.0': { enabled: true, sourceId: 'a2a.rotacc.x', inputUnit: 'radps2', operation: 'fuse_v2', invert: false, scale: 1, offset: 0 },
...
function buildDefaultConfig() {
  return {
    ...
    groundForces: {
      enabled: false,
      accelerationCompensationEnabled: true,
      heaveStabilizationEnabled: true,
      lateralMix: 1,
      longitudinalMix: 1,
      filterHz: 5,
      maxExtraG: 0.6,
    ...
    shakeMixer: {
      ...
      maxExtraG: 0.15,
      sources: {
        airframe: { invert: false, mixes: [0.25, 0.25, 0.5] },
        vertical: { invert: false, mixes: [0, 0, 1] },
        horizontal: { invert: false, mixes: [1, 0, 0] }
      }
    },
    rotationFusion: {
      correctionEnabled: true,
      correctionTauSeconds: 1.25,
      residualWashoutEnabled: false,
      residualWashoutTauSeconds: 6,
      v2DetailMix: 0.55,
      v2CorrectionTauSeconds: 0.35,
      v2BiasTauSeconds: 2.5
    },
    turbulence: {
      enabled: false,
      sourceId: 'a2a.acc.y',
