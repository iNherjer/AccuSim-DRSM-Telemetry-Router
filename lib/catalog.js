...
const DEFAULT_CHANNELS = Object.freeze({
  ...
  'ang_vel.0': { enabled: true, sourceId: 'a2a.rotacc.x', inputUnit: 'radps2', operation: 'fuse', invert: false, scale: 1, offset: 0 },
  'ang_vel.1': { enabled: true, sourceId: 'a2a.rotacc.z', inputUnit: 'radps2', operation: 'fuse', invert: false, scale: 1, offset: 0 },
  'ang_vel.2': { enabled: true, sourceId: 'a2a.rotacc.y', inputUnit: 'radps2', operation: 'fuse', invert: false, scale: 1, offset: 0 },
